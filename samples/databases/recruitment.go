...
func (db *DatabaseSample) GetRecruitmentSample(rdb string) string {
	sql := ""
	switch rdb {
	case "mysql":
		sql = db.createDatabase("db_recruitment", "mysql") + db.createRecruitmentTablesMySQL() + db.createViewsRecruitment() + db.createRecruitmentProceduresMySQL() + db.insertsRecruitment()
	case "postgres":
		sql = db.createDatabase("db_recruitment", "postgres") + db.createRecruitmentTablesPostgreSQL() + db.createViewsRecruitment() + db.createRecruitmentProceduresPostgreSQL() + db.insertsRecruitment()
	}
	return sql
}


func (db *DatabaseSample) createRecruitmentTablesMySQL() string {
return `
-- CREATE TABLES
...
func (db *DatabaseSample) createRecruitmentTablesPostgreSQL() string {
return `
DROP TABLE IF EXISTS roles;
CREATE TABLE roles (
...
DROP TABLE IF EXISTS marital_statuses;
CREATE TABLE IF NOT EXISTS marital_statuses (
	status_id SERIAL PRIMARY KEY PRIMARY KEY,
	status_name VARCHAR(100) NOT NULL UNIQUE,
	code VARCHAR(20) UNIQUE
);
...
DROP TABLE IF EXISTS identification_types;
CREATE TABLE IF NOT EXISTS identification_types (
	type_id SERIAL PRIMARY KEY PRIMARY KEY,
	type_name VARCHAR(100) NOT NULL UNIQUE,
	code VARCHAR(20) UNIQUE
);
...
DROP TABLE IF EXISTS study_areas;
CREATE TABLE IF NOT EXISTS study_areas (
	area_id SERIAL PRIMARY KEY PRIMARY KEY,
	area_name VARCHAR(100) NOT NULL UNIQUE,
	description VARCHAR(200) UNIQUE
);
...
DROP TABLE IF EXISTS degrees;
CREATE TABLE IF NOT EXISTS degrees (
	degree_id SERIAL PRIMARY KEY PRIMARY KEY,
	degree_name VARCHAR(100) NOT NULL UNIQUE,
	description VARCHAR(200) UNIQUE
);
...
DROP TABLE IF EXISTS candidates;
CREATE TABLE candidates (
    candidate_id SERIAL PRIMARY KEY PRIMARY KEY,
    user_id INT,
    country_id INT,
    identification_type_id INT,
    marital_status_id INT,
...
DROP TABLE IF EXISTS documents;
CREATE TABLE IF NOT EXISTS documents (
	document_id SERIAL PRIMARY KEY PRIMARY KEY,
    candidate_id INT NOT NULL,
    document_type_id INT NOT NULL,
    document_name VARCHAR(30),
	file_name VARCHAR(150),
...
DROP TABLE IF EXISTS contacts;
CREATE TABLE contacts (
    contact_id SERIAL PRIMARY KEY PRIMARY KEY,
    candidate_id INT NOT NULL,
    phone INT NOT NULL,
    email VARCHAR(100) NOT NULL,
    CONSTRAINT fk_candidate FOREIGN KEY(candidate_id) REFERENCES candidates(candidate_id)
...
DROP TABLE IF EXISTS addresses;
CREATE TABLE addresses (
    address_id SERIAL PRIMARY KEY PRIMARY KEY,
    candidate_id INT NOT NULL,
    state VARCHAR(50),
    city VARCHAR(50),
    district VARCHAR(50),
...
DROP TABLE IF EXISTS graduations;
CREATE TABLE IF NOT EXISTS graduations (
	graduation_id SERIAL PRIMARY KEY PRIMARY KEY,
    candidate_id INT NOT NULL,
    study_area_id INT NOT NULL,
    institute VARCHAR(150),
	degree_id INT,
...
DROP TABLE IF EXISTS vacancies;
CREATE TABLE IF NOT EXISTS vacancies (
	vacancy_id SERIAL PRIMARY KEY PRIMARY KEY,
    study_area_id INT NOT NULL,
	title VARCHAR(100),
	num_positions INT,
	start_date DATE,
...
DROP TABLE IF EXISTS job_applications;
CREATE TABLE IF NOT EXISTS job_applications (
	job_application_id SERIAL PRIMARY KEY PRIMARY KEY,
	candidate_id INT NOT NULL,
	vacancy_id INT NOT NULL,
	application_status_id INT NOT NULL,
	application_date DATE,
...
DROP TABLE IF EXISTS registrations;
CREATE TABLE registrations (
    registration_id SERIAL PRIMARY KEY PRIMARY KEY,
    user_id INT NOT NULL,
    first_name VARCHAR(100) NOT NULL,
    last_name VARCHAR(100) NOT NULL,
    email VARCHAR(150),
...
func (db *DatabaseSample) createRecruitmentProceduresMySQL() string {
return `
...
func (db *DatabaseSample) createRecruitmentProceduresPostgreSQL() string {
return `
...
func (db *DatabaseSample) createViewsRecruitment() string {
return `
-- VIEWS 
-- View view_user_data
...
func (db *DatabaseSample) insertsRecruitment() string {
return `
-- INSERTS
